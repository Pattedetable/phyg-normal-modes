...
![screenshot](https://raw.githubusercontent.com/Pattedetable/phyg-normal-modes/master/images/modes_screenshot.png)
...
Sous Windows, vous pouvez aussi double-cliquer sur le fichier ```modes.py```.
...
Moreover, on Windows, you can simply double-click on the ```modes.py``` file.
